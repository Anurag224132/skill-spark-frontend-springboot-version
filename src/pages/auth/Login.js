    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-[#050B14] overflow-hidden relative font-sans text-slate-900 dark:text-white transition-colors duration-300 selection:bg-cyan-500/30">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-24 relative z-10 border-r border-slate-200 dark:border-white/10 bg-slate-100/50 dark:bg-black/20">
        ...
        <h1 className="text-5xl font-black text-slate-900 dark:text-white leading-tight mb-6">
          Transform your career with <span className="bg-gradient-to-r from-emerald-600 to-cyan-500 bg-clip-text text-transparent">AI-driven</span> insights.
        </h1>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-slate-800 dark:text-white">Smart Matchmaking</h3>
              <p className="text-sm text-slate-600 dark:text-gray-400">Instantly match your profile to top jobs.</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-slate-800 dark:text-white">Skill Gap Analysis</h3>
              <p className="text-sm text-slate-600 dark:text-gray-400">Identify exactly what you need to learn.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 p-8 rounded-3xl backdrop-blur-xl shadow-lg dark:shadow-2xl">
            {error && (
              <div className="mb-6 bg-red-500/10 border border-red-500/30 p-4 rounded-xl flex items-center gap-3">
                <svg className="w-5 h-5 text-red-650 dark:text-red-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                <label htmlFor="email-address" className="block text-sm font-medium text-slate-600 dark:text-gray-400">Email Address</label>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-sm font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 dark:hover:text-cyan-300 transition-colors">Forgot password?</Link>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div className="text-center mt-6">
                <p className="text-slate-600 dark:text-gray-400 text-sm">
                  ...
                  <Link to="/signup" className="font-bold text-slate-800 dark:text-white hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Create one now</Link>
                </p>
              </div>
            </form>
          </div>
