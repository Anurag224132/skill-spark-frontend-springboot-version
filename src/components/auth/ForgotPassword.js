    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-[#050B14] overflow-hidden relative font-sans text-slate-900 dark:text-white transition-colors duration-300 selection:bg-cyan-500/30">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-24 relative z-10 border-r border-slate-200 dark:border-white/10 bg-slate-100/50 dark:bg-black/20">
        ...
        <h1 className="text-5xl font-black text-slate-900 dark:text-white leading-tight mb-6">
          Regain access to your <span className="bg-gradient-to-r from-emerald-600 to-cyan-500 bg-clip-text text-transparent">Career Hub</span>.
        </h1>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center border border-cyan-500/20">
              <svg className="w-6 h-6 text-cyan-600 dark:text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
            </div>
            <div>
              <h3 className="font-bold text-slate-800 dark:text-white">Secure Reset</h3>
              <p className="text-sm text-slate-600 dark:text-gray-400">We'll send an OTP to verify your identity.</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
              <svg className="w-6 h-6 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
            </div>
            <div>
              <h3 className="font-bold text-slate-800 dark:text-white">Quick Recovery</h3>
              <p className="text-sm text-slate-600 dark:text-gray-400">Get back into your account in minutes.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input id="email" name="email" type="email" required
                    className="w-full pl-11 pr-4 py-3 bg-white dark:bg-black/50 border border-slate-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-600 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
              ...
              <div className="text-center mt-6">
                <p className="text-slate-600 dark:text-gray-400 text-sm">
                  ...
                  <Link to="/login" className="font-bold text-slate-800 dark:text-white hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">Back to Login</Link>
                </p>
              </div>
            </form>
          </div>
